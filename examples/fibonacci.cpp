...
#define CPRIME_LITERAL_MEMBER(T, Underlying)   \
    template <typename Literal>                \
        requires std::is_arithmetic_v<Literal> \
...
#define CPRIME_COMPOSITE_MEMBERS(T, Underlying, ...)                                            \
  ...
  public:                                                                                       \
    ...
    [[nodiscard]] constexpr auto operator[](std::size_t index)->decltype(value[index]) {        \
        return value[index];                                                                    \
    }                                                                                           \
    [[nodiscard]] constexpr auto operator[](std::size_t index) const->decltype(value[index])& { \
        return value[index];                                                                    \
    }                                                                                           \
